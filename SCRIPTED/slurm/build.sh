...
yum -y install munge-devel munge-libs pam-devel perl-ExtUtils-MakeMaker readline-devel mysql-devel pkgconfig hwloc-devel numactl-devel ucx-devel http-parser-devel json-c-devel lua-devel hdf5-devel lz4-devel
